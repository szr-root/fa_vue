        ...
        <el-form :model="loginForm" :rules="loginRules" ref='loginFormRef'>
          <el-form-item prop="username">
            <el-input prefix-icon="User" v-model="loginForm.username"
                      placeholder="请输入用户名" :input-style="{color: '#000'}"
            />
          </el-form-item>

          <el-form-item prop="password">
            <el-input type="password" prefix-icon="Lock" v-model="loginForm.password"
                      placeholder="请输入密码" :input-style="{color: '#000'}"
            />
          </el-form-item>
          ...
          <el-form-item>
            <el-button :disabled='canClick' type="primary" @click="LoginSubmit(loginFormRef)" style="width: 100%;">登 录
            </el-button>
          </el-form-item>
